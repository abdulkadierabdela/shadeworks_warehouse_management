...
<head>
    ...
    <meta name="viewport" content="width=wellcome, initial-scale=1.0">
				    ...
				    <div class="col-xs-4">
				        <div class="form-group">
				            <div class="input-group date" id="invoice_due_date">
				                <input type="text" class="form-control required" name="invoice_due_date" placeholder="Due Date" data-date-format="" />
				                <span class="input-group-addon">
				                    <span class="glyphicon glyphicon-calendar"></span>
				                </span>
				            </div>
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<span class="invoice-vat" data-enable-vat="" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="">0.00</span>
